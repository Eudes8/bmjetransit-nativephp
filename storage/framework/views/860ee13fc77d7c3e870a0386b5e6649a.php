...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gradient-to-br from-bmje-700 to-bmje-900 text-white">
        <div class="max-w-7xl mx-auto px-4 py-20 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('catalogue')); ?>" class="bg-white text-bmje-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
                    <i class="fa-solid fa-store mr-2"></i> Explorer le catalogue
                </a>
                <a href="<?php echo e(route('register.entreprise')); ?>" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/10 transition">
    ...
    <div class="bg-gray-800 text-white">
        <div class="max-w-7xl mx-auto px-4 py-16 text-center">
            ...
            <a href="<?php echo e(route('register.entreprise')); ?>" class="bg-bmje-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-bmje-700 transition inline-block">
